...
public class Aluno extends User implements Payments {
    ...
    public void alterar(){
            ...
            System.out.println("\n1-nome\n2-email\n3-senha\n4-n° de matricula\n");
            int num = s.nextInt();
            if(num==1){System.out.println("Digite seu novo nome: ");String v = s.next();setName(v);}
            else if(num==2){System.out.println("Digite seu novo email: ");String v = s.next();setEmail(v);}
            else if(num==3){System.out.println("Digite sua nova senha: ");String v = s.next();setPassword(v);}
            else if(num==4){System.out.println("Digite seu novo n° de matricula: ");int v = s.nextInt();setMatricula(v);}
